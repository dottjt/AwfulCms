defmodule AcWeb.UserControllerTest do
  use AcWeb.ConnCase

  alias Ac.Account

  @create_attrs %{display_name: "some display_name", email: "some email", is_admin: true, name: "some name", password: "some password", password_hash: "some password_hash"}
  ...
  describe "index" do
    test "lists all users", %{conn: conn} do
      conn = get conn, user_path(conn, :homepage)
  ...
  describe "delete user" do
    ...
    test "deletes chosen user", %{conn: conn, user: user} do
      ...
      assert redirected_to(conn) == user_path(conn, :homepage)
