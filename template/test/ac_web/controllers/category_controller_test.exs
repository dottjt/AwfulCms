defmodule AcWeb.CategoryControllerTest do
  use AcWeb.ConnCase
  ...
  def fixture(:category) do
    {:ok, category} = Item.create_category(@create_attrs)
    category
  end

  describe "index" do
    test "lists all categories", %{conn: conn} do
      conn = get conn, category_path(conn, :homepage)
  ...
  describe "delete category" do
    ...
    test "deletes chosen category", %{conn: conn, category: category} do
      ...
      assert redirected_to(conn) == category_path(conn, :homepage)
