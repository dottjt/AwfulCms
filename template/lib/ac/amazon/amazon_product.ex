defmodule AmazonProduct do
    ...
    @scheme "http"
    @host   System.get_env("MARKETPLACE_HOST") #"webservices.amazon.com" # Application.get_env(:amazon_product_advertising_client, :marketplace_host, "webservices.amazon.com") # System.get_env("MARKETPLACE_HOST") 
    @path   "/onca/xml"
    ...
    defp sign_url(url_parts) do
      hmac = :crypto.hmac(
          :sha256,
          System.get_env("AWS_SECRET_ACCESS_KEY"), #"PlwtfWMlVFvkGu4Oo8sGzHBU+81jkaCwj9oYHa8k",
          # Application.get_env(:amazon_product_advertising_client, :aws_secret_access_key), #System.get_env("AWS_SECRET_ACCESS_KEY"), #
