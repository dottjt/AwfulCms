...
var _elm_lang$core$Dict$moreBlack = function (color) {
	...
	switch (_p21.ctor) {
		...
		case 'NBlack':
			return _elm_lang$core$Dict$$primary-colour
		default:
...
var _user$project$Model$tagEncoder = function (tag) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'display_name',
					_1: _elm_lang$core$Json_Encode$string(tag.display_name)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$Model$tagListEncoder = function (tagList) {
	return _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, _user$project$Model$tagEncoder, tagList));
};
...
var _user$project$Model$Product = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {id: a, name: b, display_name: c, description: d, blog_description: e, featured_image: f, draft: g, cta: h, price: i, product_type: j, url: k, url_text: l};
											};
										};
									};
								};
...
var _user$project$Model$ProductAssoc = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {id: a, name: b, display_name: c, description: d, blog_description: e, featured_image: f, draft: g, cta: h, price: i, product_type: j, url: k, url_text: l, category: m, sub_category: n, product_tags: o, product_comments: p, product_like: q};
																};
															};
														};
													};
...
var _user$project$Model$ProductCategory = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, display_name: c, description: d, icon: e};
	});
var _user$project$Model$productCategoryDecoder = A3(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductCategory))))));
var _user$project$Model$ProductSubCategory = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, display_name: c, description: d, icon: e};
	});
var _user$project$Model$productSubCategoryDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'icon',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductSubCategory))))));
var _user$project$Model$ProductTag = F4(
	function (a, b, c, d) {
		return {id: a, name: b, display_name: c, description: d};
	});
var _user$project$Model$productTagDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'description',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductTag)))));
var _user$project$Model$productTagListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Model$productTagDecoder);
var _user$project$Model$ProductLike = F2(
	function (a, b) {
		return {id: a, total: b};
	});
var _user$project$Model$productLikeDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'total',
	...
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductLike)));
var _user$project$Model$ProductComment = F2(
	function (a, b) {
		return {id: a, text: b};
	});
var _user$project$Model$productCommentDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'text',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductComment)));
var _user$project$Model$productCommentListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Model$productCommentDecoder);
var _user$project$Model$productAssocDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'product_like',
	_user$project$Model$productLikeDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'product_comments',
		_user$project$Model$productCommentListDecoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'product_tags',
			_user$project$Model$productTagListDecoder,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'sub_category',
				_user$project$Model$productSubCategoryDecoder,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'category',
					_user$project$Model$productCategoryDecoder,
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'url_text',
						_elm_lang$core$Json_Decode$string,
														...
														A3(
															...
															A3(
																...
																A3(
																	...
																	'id',
																	_elm_lang$core$Json_Decode$string,
																	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ProductAssoc))))))))))))))))));
var _user$project$Model$productAssocListDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'data',
	_elm_lang$core$Json_Decode$list(_user$project$Model$productAssocDecoder));
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {productList: a, categories: b, subCategories: c, tags: d, categorySelection: e, searchInput: f, popularQueries: g, queryTags: h, combinedTagString: i, combinedQueryString: j, error: k, route: l};
											};
										};
									};
								};
...
var _user$project$Model$WTF = {ctor: 'WTF'};
var _user$project$Model$Food = {ctor: 'Food'};
var _user$project$Model$Fashion = {ctor: 'Fashion'};
var _user$project$Model$SportsOutdoors = {ctor: 'SportsOutdoors'};
var _user$project$Model$AwesomeDork = {ctor: 'AwesomeDork'};
var _user$project$Model$HomeOffice = {ctor: 'HomeOffice'};
var _user$project$Model$Index = {ctor: 'Index'};
var _user$project$Model$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Model$WTFRoute = {ctor: 'WTFRoute'};
var _user$project$Model$FoodRoute = {ctor: 'FoodRoute'};
var _user$project$Model$FashionRoute = {ctor: 'FashionRoute'};
var _user$project$Model$SportsOutdoorsRoute = {ctor: 'SportsOutdoorsRoute'};
var _user$project$Model$AwesomeDorkRoute = {ctor: 'AwesomeDorkRoute'};
var _user$project$Model$HomeOfficeRoute = {ctor: 'HomeOfficeRoute'};
var _user$project$Model$IndexRoute = {ctor: 'IndexRoute'};

var _user$project$Msg$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Msg$ToggleQueryTag = function (a) {
	return {ctor: 'ToggleQueryTag', _0: a};
};
var _user$project$Msg$ChangeSearchInput = function (a) {
	return {ctor: 'ChangeSearchInput', _0: a};
};
var _user$project$Msg$FetchProductListSuccess = function (a) {
	return {ctor: 'FetchProductListSuccess', _0: a};
};
var _user$project$Msg$FetchProductListFail = function (a) {
	return {ctor: 'FetchProductListFail', _0: a};
};
...
var _user$project$Command$fetchSearchQuery = F2(
	function (route, searchInput) {
		return A4(
			_user$project$Helper_HttpHelper$httpGet,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'http://localhost:4000/api/fetch_grid',
				A2(
					_elm_lang$core$Basics_ops['++'],
					route,
					A2(_elm_lang$core$Basics_ops['++'], '/', searchInput))),
			_user$project$Model$productAssocListDecoder,
			_user$project$Msg$FetchProductListFail,
			_user$project$Msg$FetchProductListSuccess);
	});
var _user$project$Command$fetchNewGrid = function (route) {
	return A4(
		_user$project$Helper_HttpHelper$httpGet,
		A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000/api/fetch_grid', route),
		_user$project$Model$productAssocListDecoder,
		_user$project$Msg$FetchProductListFail,
		_user$project$Msg$FetchProductListSuccess);
};

var _user$project$Helper_FunctionHelper$replace = F3(
...
var _user$project$Helper_FunctionHelper$addQueryString = F2(
	function (queryTags, queryTag) {
		var queryTagsLengthMoreThan = _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(queryTags),
			0) > 0;
		return queryTagsLengthMoreThan ? A2(
			_elm_lang$core$Basics_ops['++'],
			queryTags,
			A2(_elm_lang$core$Basics_ops['++'], '+', queryTag)) : A2(_elm_lang$core$Basics_ops['++'], queryTags, queryTag);
	});
var _user$project$Helper_FunctionHelper$processQueryTag = F2(
	function (queryTags, queryTag) {
		var containsQueryTagPlus = A2(
			_elm_lang$core$String$contains,
			A2(_elm_lang$core$Basics_ops['++'], '+', queryTag),
			queryTags);
		var containsQueryTag = A2(_elm_lang$core$String$contains, queryTag, queryTags);
		return containsQueryTagPlus ? A3(
			_user$project$Helper_FunctionHelper$replace,
			A2(_elm_lang$core$Basics_ops['++'], '+', queryTag),
			'',
			queryTags) : (containsQueryTag ? A3(_user$project$Helper_FunctionHelper$replace, queryTag, '', queryTags) : A2(_user$project$Helper_FunctionHelper$addQueryString, queryTags, queryTag));
	});
var _user$project$Helper_FunctionHelper$parseRouteToCategorySelection = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'IndexRoute':
			return _user$project$Model$Index;
		case 'HomeOfficeRoute':
			return _user$project$Model$HomeOffice;
		case 'AwesomeDorkRoute':
			return _user$project$Model$AwesomeDork;
		case 'SportsOutdoorsRoute':
			return _user$project$Model$SportsOutdoors;
		case 'FashionRoute':
			return _user$project$Model$Fashion;
		case 'FoodRoute':
			return _user$project$Model$Food;
		case 'WTFRoute':
			return _user$project$Model$WTF;
		default:
			return _user$project$Model$Index;
	}
};
var _user$project$Helper_FunctionHelper$parseRouteToStringCommand = function (route) {
	var _p1 = route;
	switch (_p1.ctor) {
		case 'IndexRoute':
			return '/index';
...
var _user$project$Helper_FunctionHelper$parseRouteToString = function (route) {
	var _p2 = route;
	switch (_p2.ctor) {
		case 'IndexRoute':
			return '';
...
var _user$project$Helper_FunctionHelper$stringToCategory = function (stringRoute) {
	var _p3 = stringRoute;
	switch (_p3) {
		case 'home-office':
			return _user$project$Model$HomeOffice;
...
var _user$project$Helper_FunctionHelper$categoryToString = function (categorySelection) {
	var _p4 = categorySelection;
	switch (_p4.ctor) {
		case 'Index':
			return '';
		case 'HomeOffice':
...
var _user$project$Component_FilterComponent$category = F4(
	function (isChecked, displayName, categoryType, categoryIcon) {
		var _p0 = isChecked;
		if (_p0 === true) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('category checked'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'#',
								_user$project$Helper_FunctionHelper$categoryToString(categoryType))),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('category__icon'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$i,
								{
									...
									_0: _elm_lang$html$Html_Attributes$class(
										A2(_elm_lang$core$Basics_ops['++'], 'fa ', categoryIcon)),
									_1: {
										ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('category__name'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('category unchecked'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(
							A2(
...
var _user$project$Component_FilterComponent$categoryComponent = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('category__filter__container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('category__outer'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A4(
						_user$project$Component_FilterComponent$category,
						_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$Index),
						'All Products',
						_user$project$Model$Index,
						'fae-sofa'),
					_1: {
						ctor: '::',
						_0: A4(
							_user$project$Component_FilterComponent$category,
							_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$HomeOffice),
							'Home & Office',
							_user$project$Model$HomeOffice,
							'fa-fort-awesome'),
						_1: {
							ctor: '::',
							_0: A4(
								_user$project$Component_FilterComponent$category,
								_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$AwesomeDork),
								'Awesome Dork',
								_user$project$Model$AwesomeDork,
								'fae-planet'),
							_1: {
								ctor: '::',
								_0: A4(
									_user$project$Component_FilterComponent$category,
									_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$SportsOutdoors),
									'Sports & Outdoors',
									_user$project$Model$SportsOutdoors,
									'fae-sun-cloud'),
								_1: {
									ctor: '::',
									_0: A4(
										_user$project$Component_FilterComponent$category,
										_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$Fashion),
										'Fashion',
										_user$project$Model$Fashion,
										'fae-shirt'),
									_1: {
										ctor: '::',
										_0: A4(
											_user$project$Component_FilterComponent$category,
											_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$Food),
											'Food',
											_user$project$Model$Food,
											'fae-pizza'),
										_1: {
											ctor: '::',
											_0: A4(
												_user$project$Component_FilterComponent$category,
												_elm_lang$core$Native_Utils.eq(model.categorySelection, _user$project$Model$WTF),
												'WTF',
												_user$project$Model$WTF,
												'fa-bomb'),
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Component_FilterComponent$filterComponent = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('filter__container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Component_FilterComponent$categoryComponent(model),
			_1: {ctor: '[]'}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('search__title__container'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('search. product. or. tag.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Component_GridComponent$socialMediaComponent = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('social__media'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('social__item'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://facebook.com/awfulchristmas'),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fa fa-facebook-square'),
						_1: {
							ctor: '::',
							_0: _fapian$elm_html_aria$Html_Attributes_Aria$ariaHidden(true),
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'color', _1: '#3b5998'},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('https://twitter.com/awfulchristmas'),
						_1: {ctor: '[]'}
					}
				},
				{
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'color', _1: '#1dcaff'},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('https://instagram.com/awfulchristmas'),
							_1: {ctor: '[]'}
						}
					},
					{
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'color', _1: '#8a3ab9'},
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://pintrest.com/awfulchristmas'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fa fa-pinterest-square'),
									_1: {
										ctor: '::',
										_0: _fapian$elm_html_aria$Html_Attributes_Aria$ariaHidden(true),
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$style(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'color', _1: '#cb2027'},
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fa fa-reddit-square'),
										_1: {
											ctor: '::',
											_0: _fapian$elm_html_aria$Html_Attributes_Aria$ariaHidden(true),
											_1: {
...
var _user$project$Component_GridComponent$enumBottomRight = F2(
	function (product, category) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bottom-right'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('description__container'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('social_media_share'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('share me!'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Component_GridComponent$socialMediaComponent,
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$p,
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$i,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(
												A2(_elm_lang$core$Basics_ops['++'], 'fa', category.icon)),
											_1: {
												ctor: '::',
												_0: _fapian$elm_html_aria$Html_Attributes_Aria$ariaHidden(true),
												_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('like_total'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(product.product_like.total)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('like_saves'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('like_product_id'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$style(
																{
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(product.id),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$Component_GridComponent$enumTopRight = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('title__container'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(
							A2(_elm_lang$core$Basics_ops['++'], '/products/', product.name)),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('cta__container'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(product.cta),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Component_GridComponent$enumRight = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Component_GridComponent$enumTopRight(product),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Component_GridComponent$enumBottomRight, product, product.category),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Component_GridComponent$enumLeft = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(product.featured_image),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('price__container'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href(product.url),
							_1: {ctor: '[]'}
						}
					},
					{
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(product.url_text),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Component_GridComponent$enumInner = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid__inner product__inner'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('left-right-container'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Component_GridComponent$enumLeft(product),
					_1: {
						ctor: '::',
						_0: _user$project$Component_GridComponent$enumRight(product),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _user$project$Component_GridComponent$enumOuter = function (productList) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('enum__outer'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$Component_GridComponent$enumInner, productList));
};
var _user$project$Component_GridComponent$gridComponent = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid__container full_width__container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('grid__bottom__container'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$Component_FilterComponent$filterComponent(model),
						_1: {
							ctor: '::',
							_0: _user$project$Component_GridComponent$enumOuter(model.productList),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'IndexRoute':
			return _user$project$Component_GridComponent$gridComponent(model);
		case 'HomeOfficeRoute':
			return _user$project$Component_GridComponent$gridComponent(model);
		case 'AwesomeDorkRoute':
			return _user$project$Component_GridComponent$gridComponent(model);
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Model$IndexRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Model$HomeOfficeRoute,
				_evancz$url_parser$UrlParser$s('home-office')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Model$AwesomeDorkRoute,
					_evancz$url_parser$UrlParser$s('awesome-dork')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Model$SportsOutdoorsRoute,
						_evancz$url_parser$UrlParser$s('sports-outdoors')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Model$FashionRoute,
							_evancz$url_parser$UrlParser$s('fashion')),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$Model$FoodRoute,
								_evancz$url_parser$UrlParser$s('food')),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$url_parser$UrlParser$map,
									_user$project$Model$WTFRoute,
									_evancz$url_parser$UrlParser$s('wtf')),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			case 'ChangeSearchInput':
				...
				return A2(
						...
						{searchInput: _p1}),
					{
						ctor: '::',
						_0: A2(
							_user$project$Command$fetchSearchQuery,
							_user$project$Helper_FunctionHelper$parseRouteToStringCommand(route),
							_p1),
						_1: {ctor: '[]'}
					});
				...
				switch (_p2.ctor) {
					case 'IndexRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$Index, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
								_1: {ctor: '[]'}
							});
					case 'HomeOfficeRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$HomeOffice, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
					...
					case 'AwesomeDorkRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$AwesomeDork, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
					...
					case 'SportsOutdoorsRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$SportsOutdoors, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
					...
					case 'FashionRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$Fashion, categorySelection: _user$project$Model$HomeOffice, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
					...
					case 'FoodRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$Food, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
					...
					case 'WTFRoute':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{categorySelection: _user$project$Model$WTF, route: newRoute}),
							{
								ctor: '::',
								_0: _user$project$Command$fetchNewGrid(
									_user$project$Helper_FunctionHelper$parseRouteToStringCommand(newRoute)),
			...
			case 'ToggleQueryTag':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							queryTags: A2(_user$project$Helper_FunctionHelper$processQueryTag, model.queryTags, _p3)
						}),
					{
						ctor: '::',
						_0: _user$project$Command$fetchNewGrid(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Helper_FunctionHelper$parseRouteToStringCommand(model.route),
								A2(
									_elm_lang$core$Basics_ops['++'],
									model.combinedTagString,
									A2(_user$project$Helper_FunctionHelper$processQueryTag, model.queryTags, _p3)))),
						_1: {ctor: '[]'}
					});
...
var _user$project$MainGrid$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$MainGrid$initialModel = function (route) {
	return {
		productList: {ctor: '[]'},
		categories: {ctor: '[]'},
		subCategories: {ctor: '[]'},
		tags: {ctor: '[]'},
		categorySelection: _user$project$Helper_FunctionHelper$parseRouteToCategorySelection(route),
		searchInput: '',
		popularQueries: {
			ctor: '::',
			_0: 'under $20',
...
var _user$project$MainGrid$init = function (location) {
	var currentRoute = _user$project$Routing$parseLocation(location);
	return {
		ctor: '_Tuple2',
		_0: _user$project$MainGrid$initialModel(currentRoute),
		_1: _user$project$Command$fetchNewGrid(
			_user$project$Helper_FunctionHelper$parseRouteToStringCommand(currentRoute))
	};
};
var _user$project$MainGrid$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Msg$OnLocationChange,
	{init: _user$project$MainGrid$init, view: _user$project$View$page, update: _user$project$Update$update, subscriptions: _user$project$MainGrid$subscriptions})();
...
Elm['MainGrid'] = Elm['MainGrid'] || {};
if (typeof _user$project$MainGrid$main !== 'undefined') {
    _user$project$MainGrid$main(Elm['MainGrid'], 'MainGrid', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Msg.Msg":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"FetchProductListFail":["Http.Error"],"ToggleQueryTag":["String"],"FetchProductListSuccess":["Model.ProductAssocList"],"ChangeSearchInput":["String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Model.ProductCommentList":{"args":[],"type":"List Model.ProductComment"},"Model.ProductSubCategory":{"args":[],"type":"{ id : String , name : String , display_name : String , description : String , icon : String }"},"Model.ProductLike":{"args":[],"type":"{ id : String, total : Int }"},"Model.ProductComment":{"args":[],"type":"{ id : String, text : String }"},"Model.ProductAssoc":{"args":[],"type":"{ id : String , name : String , display_name : String , description : String , blog_description : String , featured_image : String , draft : Bool , cta : String , price : Float , product_type : String , url : String , url_text : String , category : Model.ProductCategory , sub_category : Model.ProductSubCategory , product_tags : Model.ProductTagList , product_comments : Model.ProductCommentList , product_like : Model.ProductLike }"},"Model.ProductTagList":{"args":[],"type":"List Model.ProductTag"},"Model.ProductCategory":{"args":[],"type":"{ id : String , name : String , display_name : String , description : String , icon : String }"},"Model.ProductAssocList":{"args":[],"type":"List Model.ProductAssoc"},"Model.ProductTag":{"args":[],"type":"{ id : String , name : String , display_name : String , description : String }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Msg.Msg"},"versions":{"elm":"0.18.0"}});
}
Elm['Model'] = Elm['Model'] || {};
...
if (typeof _user$project$Routing$main !== 'undefined') {
    _user$project$Routing$main(Elm['Routing'], 'Routing', {"types":null,"versions":{"elm":"0.18.0"}});
}
