...
socialMediaComponent =
    div [ class "social__media" ]
        [ a [ class "social__item", href "https://facebook.com/awfulchild" ]
            [ i [ class "fa fa-facebook-square", ariaHidden True, style [ ( "color", "#3b5998" ) ] ]
                []
            ]
        , a [ class "social__item", href "https://twitter.com/awfulchild" ]
            [ i [ class "fa fa-twitter-square", ariaHidden True, style [ ( "color", "#1dcaff" ) ] ]
                []
            ]
        , a [ class "social__item", href "https://instagram.com/awfulchild" ]
            [ i [ class "fa fa-instagram", ariaHidden True, style [ ( "color", "#8a3ab9" ) ] ]
                []
            ]
        , a [ class "social__item", href "https://pintrest.com/awfulchild" ]
