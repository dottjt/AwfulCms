...
categoryComponent model =
    div [ class "category__filter__container" ]
        [ div [ class "category__outer" ]
              ...
              , category (model.categorySelection == Home) "Home" Home "fa-home-kennel"
              , category (model.categorySelection == SportsOutdoors) "Sports & Outdoors" SportsOutdoors "fae-sun-cloud"
              , category (model.categorySelection == Fashion) "Fashion" Fashion "fa-fashion-collar"
              , category (model.categorySelection == Food) "Food" Food "fae-meat"
              , category (model.categorySelection == Toys) "Toys" Toys "fa-toy-tennisball"
              ]
        ]
