...
categoryComponent model =
    div [ class "category__filter__container" ]
        [ div [ class "category__outer" ]
              ...
              , category (model.categorySelection == Accessories) "Accessories" Accessories "fa-fort-awesome"
              , category (model.categorySelection == DressesSkirts) "Dresses & Skirts" DressesSkirts "fae-planet"
              , category (model.categorySelection == ShirtsTops) "Shirts & Tops" ShirtsTops "fae-sun-cloud"
              , category (model.categorySelection == PantsShorts) "Pants & Shorts" PantsShorts "fae-shirt"
              , category (model.categorySelection == SportsFun) "Sports & Fun" SportsFun "fae-pizza"
              , category (model.categorySelection == Footwear) "Footwear" Footwear "fa-bomb"
              , category (model.categorySelection == Headwear) "Headwear" Headwear ""
              , category (model.categorySelection == Sexy) "Sexy" Sexy ""
              , category (model.categorySelection == CoatsJackets) "CoatsJackets" CoatsJackets ""
              ]
        ]
...
--               , selectionCategory (model.gridSelection == Category) "#category/accessories" "Category"
--               ]
--         ] 
