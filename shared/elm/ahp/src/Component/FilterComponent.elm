...
categoryComponent model =
    div [ class "category__filter__container" ]
        [ div [ class "category__outer" ]
              ...
              , category (model.categorySelection == TV) "TV" TV "fae-sun-cloud"
              , category (model.categorySelection == VideoGames) "Video Games" VideoGames "fae-sun-cloud"
              , category (model.categorySelection == Fashion) "Fashion" Fashion "fae-shirt"
              , category (model.categorySelection == Collection) "Collection" Collection "fa-bomb"
              ]
        ]
