...
update msg model =
    case msg of
        ...
        OnLocationChange location ->
            ...
            in
                case newRoute of 
                    ...
                    AwesomeDorkRoute -> 
                        { model | categorySelection = AwesomeDork, route = newRoute } ! [ fetchNewGrid (parseRouteToStringCommand newRoute) ]
                    SportsOutdoorsRoute ->
                    ...
                    WTFRoute ->        
                        { model | categorySelection = WTF, route = newRoute } ! [ fetchNewGrid (parseRouteToStringCommand newRoute) ]
        ...
        --         AwesomeDork -> 
        --             { model | categorySelection = AwesomeDork } ! []
        --         SportsOutdoors ->
