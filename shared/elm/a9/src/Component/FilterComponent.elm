...
categoryComponent model =
    div [ class "category__filter__container" ]
        [ div [ class "category__outer" ]
              ...
              , category (model.categorySelection == HomeOffice) "Home & Office" HomeOffice "fa-fort-awesome"
              , category (model.categorySelection == TV) "TV" TV "fae-planet"
              , category (model.categorySelection == Music) "Music" Music "fae-sun-cloud"
              , category (model.categorySelection == Fashion) "Fashion" Fashion "fae-shirt"
              , category (model.categorySelection == Toys) "Toys" Toys "fae-pizza"
              , category (model.categorySelection == VideoGames) "VideoGames" VideoGames "fa-bomb"
              ]
        ]
