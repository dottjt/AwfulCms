defmodule AwfulWeb.MessageControllerTest do
  ...
  describe "update message" do
    ...
    test "redirects when data is valid", %{conn: conn, message: message} do
      ...
      assert html_response(conn, 200) =~ "some updated command"
    end
