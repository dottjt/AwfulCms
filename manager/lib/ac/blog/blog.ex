defmodule Ac.Blog do
  ...
  def get_post_repo!(id, repo), do: repo.get!(Post, id)
  ...
  def create_post_repo(attrs \\ %{}, repo) do
    %Post{}
    |> Post.changeset(attrs)
    |> repo.insert()
  end
  ...
  """
  def update_post_repo(%Post{} = post, attrs, repo) do
    post
    |> Post.changeset(attrs)
    |> repo.update()
  end
  ...
  def delete_post_repo(%Post{} = post, repo) do
    repo.delete(post)
  end
  ...
  def get_update_repo!(id, repo), do: repo.get!(Update, id)
  ...
  def create_update_repo(attrs \\ %{}, repo) do
    %Update{}
    |> Update.changeset(attrs)
    |> repo.insert()
  end
  ...
  def update_update_repo(%Update{} = update, attrs, repo) do
    update
    |> Update.changeset(attrs)
    |> repo.update()
  end
  ...
  def delete_update_repo(%Update{} = update, repo) do
    repo.delete(update)
  end
  ...
  def get_social_media_repo!(id, repo), do: repo.get!(SocialMedia, id)
  ...
  def update_social_media_repo(%SocialMedia{} = social_media, attrs, repo) do
    social_media
    |> SocialMedia.changeset(attrs)
    |> repo.update()
  end
  ...
  def delete_social_media_repo(%SocialMedia{} = social_media, repo) do
    repo.delete(social_media)
  end
